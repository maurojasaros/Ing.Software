"""
Django settings for HotelProyecto project.
...
SECRET_KEY = 'django-insecure-tsi#!39&m&m@w*k*hhburd2telx2y_pb11721rk@7%+7z7rz+='
...
ROOT_URLCONF = 'HotelProyecto.urls'
...
WSGI_APPLICATION = 'HotelProyecto.wsgi.application'
